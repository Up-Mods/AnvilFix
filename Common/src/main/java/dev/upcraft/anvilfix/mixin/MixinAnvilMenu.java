...
public class MixinAnvilMenu {
    ...
    @ModifyExpressionValue(method = {"lambda$onTake$2", "method_24922", "m_150476_"}, require = 1, remap = false, at = @At(value = "FIELD", target = "Lnet/minecraft/world/entity/player/Abilities;instabuild:Z"))
